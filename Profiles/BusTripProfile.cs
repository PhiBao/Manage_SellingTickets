...
namespace backend.Profiles
{
    public class BusTripProfile: Profile
    {
        public BusTripProfile()
        {
            ...
            .ForMember(dest => dest.MaNhaXe, opt => opt.MapFrom(src => src.MaXeNavigation.MaNhaXe))
            ...
            .ForMember(dest => dest.SoChoNgoi, opt => opt.MapFrom(src => src.MaXeNavigation.SoChoNgoi))
            .ForMember(dest => dest.NgayXuatBen, opt => opt.MapFrom(src => Array.ConvertAll(src.LichTrinh.ToCharArray(),
                                                                    c => (MappingDate(c, src.GioXuatBen)))));
